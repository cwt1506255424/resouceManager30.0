$(function() {
    ...
    //         }
    // })
    $("#u11799").click(function() {
        console.log(1);
        var html11 = $(this).find("span").html();
        if ($("#u11798_input").val() == "") {
            $("#u11798_input").val(html11);
            $("#u11799").unbind("click");
        } else {
            $("#u11798_input").val($("#u11798_input").val() + "," + html11);
            $("#u11799").unbind("click");
        }

    })
    $("#u11801").click(function() {
        console.log(1);
        var html22 = $(this).find("span").html();
        if ($("#u11798_input").val() == "") {
            $("#u11798_input").val(html22);
            $("#u11801").unbind("click");
        } else {
            $("#u11798_input").val($("#u11798_input").val() + "," + html22);
            $("#u11801").unbind("click");
        }

    })
    $("#u11803").click(function() {
        console.log(1);
        var html33 = $(this).find("span").html();
        if ($("#u11798_input").val() == "") {
            $("#u11798_input").val(html33);
            $("#u11803").unbind("click");
        } else {
            $("#u11798_input").val($("#u11798_input").val() + "," + html33);
            $("#u11803").unbind("click");
        }

    })

    $("#u11805").click(function() {
        console.log(1);
        var html44 = $(this).find("span").html();
        if ($("#u11798_input").val() == "") {
            $("#u11798_input").val(html44);
            $("#u11805").unbind("click");
        } else {
            $("#u11798_input").val($("#u11798_input").val() + "," + html44);
            $("#u11805").unbind("click");
        }
    ...
    var resource_id = $.cookie("edit_id");
    var xueduan_selected = $("#xueduan").val();
    var xueke_selected = $("#xueke").val();
    var jxnr_selected = $("#jxnr_view").val();
    var resourceType = $("input:radio:checked").val();
    var resourceName = $("#u11815_input").val();
    var resourceIntroduce = $("#u11747_input").val();
    var resourceTag = $("#u11798_input").val();
    var resourceDetail = { "resource_id": resource_id, "xueduan": xueduan_selected, "xueke": xueke_selected, "jxnr": jxnr_selected, "resourceType": resourceType, "resourceName": resourceName, "resourceIntroduce": resourceIntroduce, "resourceTag": resourceTag };
    //var resourceUpload = urlx;
    $.post("url3", resourceDetail, function(data) { //url1更新信息的后台操作
        if (data === true) {
...
// $.post(url1, resourceDetail, function(data) { //url1更新信息的后台操作
//     if (data === true) {
//         window.location.href = "编辑资源修正";
//     }
// }, function(err) {
//     console.log(err);
// })

// $("#u11748").click(function() {
//     $.ajax({
//         type: "post",
//         url: "url1",
//         async: true,
